...
trait HasReviews
{
    ...
    {
        $this->reviewsRelation()->create(['user_id' => $user->id()]);
    ...
    {
        optional($this->reviewsRelation()->where('user_id', $user->id())->first())->delete();
    ...
    {
        return $this->reviewsRelation()->where('user_id', $user->id())->exists();
    }
}