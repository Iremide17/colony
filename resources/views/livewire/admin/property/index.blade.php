<div>
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12">
            ...
            @if($selectedRows)
                <div class="row">
                    <div class="col-lg-2"><button wire:click.prevent="acceptAll" class="btn btn-theme btn-sm">Accept all</button></div>
                    <div class="col-lg-2"><button wire:click.prevent="rejectAll" class="btn btn-warning btn-sm">Reject all</button></div>
                    <div class="col-lg-2"><button wire:click.prevent="deleteAll" class="btn btn-danger btn-sm">Delete All</button></div>
                </div>
            @endif
                                    ...
                                    <td>
                                        <div class="_leads_action">
                                            ...
                                            @if ($property->isVerified == false)
                                                <a wire:click.prevent="acceptProperty({{ $property->id() }})"><i class="fas fa-check"></i></a>
                                            @else
                                                <a wire:click.prevent="unacceptProperty({{ $property->id() }})"><i class="fas fa-times"></i></a>
                                            @endif
                                        </div>
                                    </td>
                                </tr>
