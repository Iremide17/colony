                ...
                <div class="table-responsive">
                    <table class="table">
                        <thead class="thead-dark">
                            <tr>
                                <th scope="col" class="m2_hide">
                                    <input wire:model="selectPageRows" type="checkbox" class="" name="todo2" id="todoCheck2">
                                </th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="m2_hide">
                                    <input wire:model="selectedRows" type="checkbox" value="{{ $freelancer->id() }}" name="todo2" id="{{ $freelancer->id() }}">
                                </td>
                                <td>
