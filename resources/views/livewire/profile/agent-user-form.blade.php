<x-jet-form-section submit="updateAgentInformation">
    <x-slot name="title">
        {{ __('Agent Information') }}
    </x-slot>

    <x-slot name="description">
        {{ __('Update your agent account\'s profile information.') }}
    </x-slot>

    <x-slot name="form">

        <div class="col-span-6 sm:col-span-4">
            <x-jet-input id="photo" type="file" class="mt-1 block w-full" wire:model.defer="agent.photo" autocomplete="photo" />
