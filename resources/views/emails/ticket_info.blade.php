                                ...
                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                    <tr>
                                        <td bgcolor="#ffffff" width="100" align="left">
                                            <a href="{{ url('/')}}">
                                                <img alt="Colony Logo" src="{{ asset('storage/',application('image'))}}" width="52" height="78" style="display: block; font-family: Helvetica, Arial, sans-serif; color: #666666; font-size: 16px;"
                                                    border="0">
                                            </a>
                                        </td>
                                            ...
                                            <table border="0" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td align="right" alt="Quick Support" style="padding: 0 0 5px 0; font-size: 14px; font-family: Arial, sans-serif; color: #666666; text-decoration: none;">
                                                        <span style="color: #666666; text-decoration: none;">{{ application('name')}} - {{ application('motto') }}
                                                            <br>{{ application('slogan') }}
                                                        </span>
                                                    </td>
                                                </tr>
                                            </table>
                            ...
                            <table width="500" border="0" cellspacing="0" cellpadding="0" align="center" class="responsive-table">
                                <tr>
                                    <td align="center" valign="middle" style="font-size: 12px; line-height: 18px; font-family: Helvetica, Arial, sans-serif; color:#666666;">
                                        <span class="appleFooter" style="color:#666666;">All rights reserved © {{ application('name')}}</span>
                                        <br>
